...
## Project Structure
    ...
    ├── testapiautostorybo_121297  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_121297`
...
2. Clone this repo and `cd testapiautostorybo_121297`
